...
from food.views import (
    MealViewSet, MealCompletionViewSet, CompleteMealView, PreparationViewSet,
    UserDailyMealsView, MealDetailView, PreparationStepViewSet)
...
step_router.register(r'', PreparationStepViewSet, basename='preparation-steps')
...
urlpatterns = [
    ...
    path('api/preparation-steps/',include((step_router.urls,'steps'))),
